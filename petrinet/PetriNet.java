...
public class PetriNet<T> {
    ...
    /// Queue of threads to awake (used if fair). There is always one more semaphore on this list.
    /// He is representing next process, that could fire in future.
    /// Always 1 or 0 of those semaphores are acquirable.
